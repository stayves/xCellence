...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'Instagram',
      url: 'https://instagram.com/xcellenceftc',
      icon: (
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/xcellenceftc',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'YouTube',
      url: 'https://youtube.com/@xcellenceftc',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Facebook',
      url: 'https://facebook.com/xcellenceftc',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/xcellenceftc',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <p className="contact-info">
              ...
              info@xcellenceftc.com
            </p>
            <p className="contact-info">
              <strong>For Sponsorships:</strong><br />
              sponsor@xcellenceftc.com
            </p>
          </div>
